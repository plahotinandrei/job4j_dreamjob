...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdThenGetPageWithVacancyOne() {
        var expectedVacancies = new Vacancy(1, "test", "desc", now(), true, 1, 2);
        when(vacancyService.findById(any(Integer.class))).thenReturn(Optional.of(expectedVacancies));
        var model = new ConcurrentModel();
    ...
    @Test
    public void whenPostVacancyUpdateThenRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "test", "desc", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenPostVacancyUpdateThenGetErrorMessage() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
        var vacancy = new Vacancy(1, "test", "desc", now(), true, 1, 2);
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenRequestVacancyDeleteByIdThenRedirectToVacanciesPage() {
    ...
    @Test
    public void whenRequestVacancyDeleteByIdThenGetErrorMessage() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
